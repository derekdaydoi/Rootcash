(function (root, factory) {
  ...
  function roundUp(value, step = 500000) {
    if (value <= 0) return 0;
  ...
  function calculateBuffer(incomes, expenses, safetyRate = 10) {
    ...
    // Same-day obligations are treated before inflows: conservative liquidity planning.
    events.sort((a, b) => {
    ...
    return {
      ...
      totalExpense,
      flexible: Math.max(0, sum(incomes) - totalExpense),
      endingNet: running,
      events,
    };
  }
